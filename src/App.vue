<template>
              ...
              <div class="container">
                <div class="row">
                  <div class="menu-info d-flex justify-content-between align-items-center">
                    ...
                    <router-link :to="{name: 'main'}"> <img src="http://localhost:8000/src/assets/images/logo/logo.png"
                                                             alt=""> </router-link>
        ...
        <div class="d-lg-block d-none">
          <div class="row g-0 position-relative">
            <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
              <div class="logo"><router-link :to="{name: 'main'}"> <img src="http://localhost:8000/src/assets/images/logo/logo.png"
                                                                        alt=""> </router-link>
              </div>
            </div>
                    ...
                    <div class=" d-flex align-items-center justify-content-between ">
                      ...
                      <div class="right d-flex align-items-center justify-content-end">
                        <ul class="main-menu__widge-box d-flex align-items-center ">
                          ...
                          <li class="cartm"><a @click.prevent="getCartProducts" href="#0" class="number cart-icon"> <i
    ...
    <div class="sticy-header">
      ...
      <div class="container position-relative d-lg-block d-none">
        <div class="d-flex align-items-center justify-content-between"><a href="index.html" class="logo me-2">
          <img src="http://localhost:8000/src/assets/images/logo/logo.png" alt=""> </a>
          <div class="mega-menu-default mega-menu d-lg-block d-none">
            <div class="container ">
              <div class="row">
                <nav>
    ...
    <div class="side-cart d-flex flex-column justify-content-between">
      <div class="top">
        ...
        <div class="cart_items">
          <div v-for="product in products" class="items d-flex justify-content-between align-items-center">
            ...
            <div class="right">
              <div @click.prevent="removeProduct(product.cart_id)" class="item-remove"><i class="flaticon-cross"></i></div>
            </div>
          </div>
        </div>
      </div>
      <div class="bottom">
        <div class="total-ammount d-flex justify-content-between align-items-center">
          ...
          <h6 v-if="subtotal !== null" class="ammount text-uppercase">${{ subtotal }}</h6>
        </div>
        <div class="button-box d-flex justify-content-between">
          <router-link :to="{name: 'cart.index'}" href="cart.html" class="btn_black"> Checkout
          </router-link>
        </div>
      </div>
    </div>
        ...
        <div class="sidebar-textwidget">
          <div class="sidebar-info-contents">
            <div class="content-inner">
              <div class="logo"><router-link :to="{name: 'main'}"><img src="http://localhost:8000/src/assets/images/logo/logo-2.png"
                                                                       alt=""> </router-link>
              </div>
  ...
  <router-view :data="products"></router-view>

  <!--  Footer Three start -->
  <footer class="footer-default footer-3 ">
    <div class="footer-default__shap_1 position-absolute "><img
        src="http://localhost:8000/src/assets/images/shape/footer-shape-1.png"
        alt=""></div>
    <!--Start Footer-->
      ...
      <div class="container">
        <div class="footer_bottom_content">
          ...
          <div class="footer-payment wow fadeInUp animated">
            <a href="#0"> <img src="http://localhost:8000/src/assets/images/home-four/method-1.jpg" alt="payment"> </a>
            <a href="#0"> <img src="http://localhost:8000/src/assets/images/home-four/method-2.jpg" alt="payment"> </a>
            <a href="#0"> <img src="http://localhost:8000/src/assets/images/home-four/method-3.jpg" alt="payment"> </a>
            <a href="#0"> <img src="http://localhost:8000/src/assets/images/home-four/method-4.jpg" alt="payment"> </a>
          </div>
        </div>
      </div>
    </div>
    ...
    countCartSubtotal() {
      if (this.products !== null) {
        this.products.forEach(productSubtotal => {
          this.subtotal.push(productSubtotal.qty * productSubtotal.price)
        })
        ...
        function count(arr) {
          ...
          this.subtotal = count(this.subtotal)
      } else {
        this.subtotal = null
      }
