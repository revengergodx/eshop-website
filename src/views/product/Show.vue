              ...
              <div class="big-product single-product-one slider-for">
                <div>
                  <div class="single-item"><img :src="product.image_url" alt="">
                    <div v-if="product.discount > 0" class="ptag"><span class="one">-{{ product.discount }}% </span>
                    </div>
                    <a href="#0"
              ...
              <div class="navholder">
                <div class="product-slicknav single-product-one-nav slider-nav">
                  <div> <span class="single-item"> <img
                      :src="product.image_url" alt=""> </span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="shop-details-top-right-content-box">
                ...
                <div class="shop-details-top-size-box">
                  ...
                  <div class="shop-details-top-size-list-box">
                    <ul class="shop-details-top-size-list">
                      <li v-for="size in product.sizes"><a @click.prevent="addSize(size)"
                                                           :class="{'bg-primary': sizes.includes(size)}"
                                                           href="#0">{{ size.title }}</a></li>
                    </ul>
                    <p class="shop-details-top-size-guide"><a href="#0">Size Guide</a></p>
                  </div>
                </div>
                <div class="shop-details-top-color-sky-box">
                  <h4>Choose available color: </h4>
                  <ul class="varients">
                    <li v-for="color in product.colors">
                      <a @click.prevent="addColor(color)" href="#0" class="shop-details-top-color-sky-img"
                         style="width: 50px; height: 50px"
                         :style="`background-color: #${color.hex}`"
                         :class="{'rounded-circle': colors.includes(color)}">
                      </a></li>
                  </ul>
                </div>
                ...
                <div class="product-quantity">
                  ...
                  <div class="product-quantity-box d-flex align-items-center flex-wrap">
                    ...
                    <div v-else class="product-quantity-check"><i class="flaticon-delete" style="color: red"></i>
                      <p>Out of Stock</p>
                    </div>
                  </div>
                </div>
                <div class="shop-details-top-order-now">
                  <p v-if="product.count < 30"><i class="flaticon-point"></i>Order Now, Only {{ product.count }} Left !
                  </p>
                </div>
                  ...
                  <ul class="shop-details-top-safe-checkout-list">
                    <li>
                      <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                          src="http://localhost:8000/src/assets/images/shop/shop-details-top-safe-checkout-img-1.jpg"
                          alt=""></a></div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                          src="http://localhost:8000/src/assets/images/shop/shop-details-top-safe-checkout-img-2.jpg"
                          alt=""></a></div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                          src="http://localhost:8000/src/assets/images/shop/shop-details-top-safe-checkout-img-3.jpg"
                          alt=""></a></div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                          src="http://localhost:8000/src/assets/images/shop/shop-details-top-safe-checkout-img-4.jpg"
                          alt=""></a></div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                          src="http://localhost:8000/src/assets/images/shop/shop-details-top-safe-checkout-img-5.jpg"
                          alt=""></a></div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                          src="http://localhost:8000/src/assets/images/shop/shop-details-top-safe-checkout-img-7.jpg"
                          alt=""></a></div>
                    </li>
                  </ul>
                </div>
              ...
              <div class="product-drescription">
                ...
                <div class="row align-items-center">
                  <div class="col-lg-4 mt-30 ">
                    <div class="thumb"><img
                        src="http://localhost:8000/src/assets/images/shop/shop-details-tab-content-specification-img-1.jpg"
                        alt=""></div>
                  </div>
      ...
      <div class="container ">
        ...
        <div class="row mt-30 wow fadeInUp animated">
          <div class="catagory-slider">
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                <a href="shop-details-1.html" class="d-block products-grid__image_holder"> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img1.jpg" alt="Alt"> </a>
                          ...
                          <div class="popup-product-thumb-box">
                            <ul>
                              <li class="tab-nav popup-product-thumb"><a href="#tab7">
                                <img src="http://localhost:8000/src/assets/images/shop/products-img1.jpg"
                                     alt="img"> </a></li>
                              <li class="tab-nav popup-product-thumb "><a href="#tab8">
                                <img src="http://localhost:8000/src/assets/images/shop/products-img2.jpg"
                                     alt="img"> </a></li>
                              <li class="tab-nav popup-product-thumb "><a href="#tab9">
                                <img src="http://localhost:8000/src/assets/images/shop/products-img3.jpg"
                                     alt="img"> </a></li>
                            </ul>
                          </div>
                          <div class="popup-product-main-image-box">
                            <div id="tab7" class="tab-item popup-product-image">
                              <div class="popup-product-single-image"><img
                                  src="http://localhost:8000/src/assets/images/shop/products-img1.jpg"
                                  alt="img"></div>
                            </div>
                            <div id="tab8" class="tab-item popup-product-image">
                              <div class="popup-product-single-image"><img
                                  src="http://localhost:8000/src/assets/images/shop/products-img2.jpg"
                                  alt="img"></div>
                            </div>
                            <div id="tab9" class="tab-item popup-product-image">
                              <div class="popup-product-single-image"><img
                                  src="http://localhost:8000/src/assets/images/shop/products-img3.jpg"
                                  alt="img"></div>
                            </div>
                    ...
                    <div class="col-lg-6">
                      <div class="popup-right-content">
                        ...
                        <div class="payment-method"><a href="#0"> <img
                            src="http://localhost:8000/src/assets/images/payment_method/method_1.png" alt=""> </a>
                          <a href="#0"> <img src="http://localhost:8000/src/assets/images/payment_method/method_2.png"
                                             alt=""> </a> <a href="#0"> <img
                              src="http://localhost:8000/src/assets/images/payment_method/method_3.png" alt=""> </a>
                          <a href="#0"> <img src="http://localhost:8000/src/assets/images/payment_method/method_4.png"
                                             alt=""> </a></div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                <div v-if="product.discount" class="products-grid-one__badge-box"> <span
                    class="bg_black badge discount">-{{ product.discount }}%</span></div>
                <a href="shop-details-1.html"
                   class="d-block products-grid__image_holder"> <img
                    ...
                    src="http://localhost:8000/src/assets/images/shop/products-img3.jpg" alt="Alt"> <img
                    class="products-grid-one__hover-img"
                    src="http://localhost:8000/src/assets/images/shop/products-img4.jpg"
                    alt="Alt"> </a>
                <div class="products-grid__usefull-links">
                  <ul>
                    <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                          ...
                          <div class="popup-product-thumb-box">
                            <ul>
                              ...
                              <li class="tab-nav popup-product-thumb "><a href="#tab888">
                                <img src="http://localhost:8000/src/assets/images/shop/products-img4.jpg"
                                     alt="img"> </a></li>
                              <li class="tab-nav popup-product-thumb "><a href="#tab999">
                                <img src="http://localhost:8000/src/assets/images/shop/products-img5.jpg"
                                     alt="img"> </a></li>
                            </ul>
                          </div>
                          <div class="popup-product-main-image-box">
                            ...
                            <div id="tab888" class="tab-item popup-product-image">
                              <div class="popup-product-single-image"><img
                                  src="http://localhost:8000/src/assets/images/shop/products-img5.jpg"
                                  alt="img"></div>
                            </div>
                            <div id="tab999" class="tab-item popup-product-image">
                              <div class="popup-product-single-image"><img
                                  src="http://localhost:8000/src/assets/images/shop/products-img6.jpg"
                                  alt="img"></div>
                            </div>
                            <button class="prev"><i class="flaticon-back"></i>
                            </button>
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient"><span class="color"> Yellow </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img3.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> blue </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img4.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> Black </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img5.jpg" alt="Alt"></p>
              </div>
            </div>
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                <a
                    ...
                    class="products-grid-one__mainimage products-grid-one__first-img"
                    src="http://localhost:8000/src/assets/images/shop/products-img4.jpg" alt="Alt"> <img
                    class="products-grid-one__hover-img"
                    src="http://localhost:8000/src/assets/images/shop/products-img5.jpg"
                    alt="Alt"> </a>
                <div class="products-grid__usefull-links">
            ...
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                <a href="shop-details-1.html" class="d-block products-grid__image_holder"> <img
                    ...
                    src="http://localhost:8000/src/assets/images/shop/products-img6.jpg" alt="Alt"> </a>
                <div class="products-grid__usefull-links">
                  <ul>
                    <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                                                    wishlist</span> </a></li>
                        ...
                        <div class="tabs">
                          <div class="popup-product-thumb-box">
                            <ul>
                              ...
                              <li class="tab-nav popup-product-thumb "><a
                                  href="#tab99999"> <img
                                  src="http://localhost:8000/src/assets/images/shop/products-img7.jpg"
                                  alt="img"> </a></li>
                            </ul>
                          </div>
                          <div class="popup-product-main-image-box">
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient"><span class="color"> blue </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img6.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> Yellow </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img5.jpg" alt="Alt"></p>
              </div>
            </div>
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                <a href="shop-details-1.html" class="d-block products-grid__image_holder"> <img
                    class="products-grid-one__mainimage products-grid-one__first-img"
                    src="http://localhost:8000/src/assets/images/shop/products-img6.jpg" alt="Alt"> <img
                    class="products-grid-one__hover-img"
                    src="http://localhost:8000/src/assets/images/shop/products-img2.jpg"
                    alt="Alt"> </a>
                <div class="products-grid__usefull-links">
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient"><span class="color"> Blue </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img6.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> Yellow </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img7.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> green </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img8.jpg" alt="Alt"></p>
              </div>
            </div>
            <div class="products-grid-one">
              <div class="products-grid-one__product-image"><a href="shop-details-1.html"
                                                               class="d-block products-grid__image_holder"> <img
                  class="products-grid-one__mainimage products-grid-one__first-img"
                  src="http://localhost:8000/src/assets/images/shop/products-img12.jpg" alt="Alt"> <img
                  class="products-grid-one__hover-img"
                  src="http://localhost:8000/src/assets/images/shop/products-img11.jpg"
                  alt="Alt"> </a>
                <div class="products-grid__usefull-links">
                  <ul>
                    <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                        ...
                        <div class="tabs">
                          <div class="popup-product-thumb-box">
                            <ul>
                              <li class="tab-nav popup-product-thumb"><a href="#ttab111">
                                <img src="http://localhost:8000/src/assets/images/shop/products-img9.jpg"
                                     alt="img"> </a></li>
                              <li class="tab-nav popup-product-thumb "><a
                                  href="#ttab222"> <img
                                  src="http://localhost:8000/src/assets/images/shop/products-img10.jpg"
                                  alt="img"> </a></li>
                              <li class="tab-nav popup-product-thumb "><a
                                  href="#ttab333"> <img
                                  src="http://localhost:8000/src/assets/images/shop/products-img11.jpg"
                          ...
                          <div class="popup-product-main-image-box">
                            <div id="ttab111" class="tab-item popup-product-image">
                              <div class="popup-product-single-image"><img
                                  src="http://localhost:8000/src/assets/images/shop/products-img9.jpg"
                                  alt="img"></div>
                            </div>
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient"><span class="color"> Blue </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img12.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> Green </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img11.jpg" alt="Alt"></p>
                <p class="products-grid-one__product-varient"><span class="color"> Black </span> <img
                    src="http://localhost:8000/src/assets/images/shop/products-img10.jpg" alt="Alt"></p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    addToCart(product) {
      if (this.sizes == 0 || this.colors == 0) {
        alert('Select available color or size')
      } else {
    ...
    getProduct(id) {
      this.axios.post(`http://localhost:8876/api/products/${this.$route.params.id}`)
          .then(res => {
